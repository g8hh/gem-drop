/**
* Custom Render.js. Native Render.js has a floating point bug with sprite rendering & context transforms.
**************
        ...
        for (i = 0; i < bodies.length; i++) {
            ...
            for (k = body.parts.length > 1 ? 1 : 0; k < body.parts.length; k++) {
                ...
                if (part.render.sprite && part.render.sprite.texture && !options.wireframes && (!Settings || Settings.render_sprites)) {
                    ...
                    // ...except for some reason it does not work correctly
                    // c.rotate(-part.angle);
                    // c.translate(-part.position.x, -part.position.y); 
